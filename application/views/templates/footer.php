  ...
  <script type="text/javascript">
    ...
    function change_top_5_sales (option){
        filter_top5 = option;
        if (filter_top5 == '01') {  
          var databar = [<?= $top_5_sales_val_01; ?>];
          var kategoribar = [<?= $top_5_sales_name_01; ?>];
        }else if(filter_top5 == '02'){  
          var databar = [<?= $top_5_sales_val_02; ?>];
          var kategoribar = [<?= $top_5_sales_name_02; ?>];
        }else if(filter_top5 == '03'){  
          var databar = [<?= $top_5_sales_val_03; ?>];
          var kategoribar = [<?= $top_5_sales_name_03; ?>];
        }else if(filter_top5 == '04'){  
          var databar = [<?= $top_5_sales_val_04; ?>];
          var kategoribar = [<?= $top_5_sales_name_04; ?>];
        }else if(filter_top5 == '05'){  
          var databar = [<?= $top_5_sales_val_05; ?>];
          var kategoribar = [<?= $top_5_sales_name_05; ?>];
        }else if(filter_top5 == '06'){  
          var databar = [<?= $top_5_sales_val_06; ?>];
          var kategoribar = [<?= $top_5_sales_name_06; ?>];
        }else if(filter_top5 == '07'){  
          var databar = [<?= $top_5_sales_val_07; ?>];
          var kategoribar = [<?= $top_5_sales_name_07; ?>];
        }else if(filter_top5 == '08'){  
          var databar = [<?= $top_5_sales_val_08; ?>];
          var kategoribar = [<?= $top_5_sales_name_08; ?>];
        }else if(filter_top5 == '09'){  
          var databar = [<?= $top_5_sales_val_09; ?>];
          var kategoribar = [<?= $top_5_sales_name_09; ?>];
        }else if(filter_top5 == '10'){  
          var databar = [<?= $top_5_sales_val_10; ?>];
          var kategoribar = [<?= $top_5_sales_name_10; ?>];
        }else if(filter_top5 == '11'){  
          var databar = [<?= $top_5_sales_val_11; ?>];
          var kategoribar = [<?= $top_5_sales_name_11; ?>];
        }else if(filter_top5 == '12'){  
          var databar = [<?= $top_5_sales_val_12; ?>];
          var kategoribar = [<?= $top_5_sales_name_12; ?>];
        }else{
          var databar = [<?= $top_5_sales_val; ?>];
          var kategoribar = [<?= $top_5_sales_name; ?>];
        }
            ...
            click: function(event, chartContext, config, val) {
              ...
              console.log(bulan);
                $.ajax({  
                  ...
                  method:"POST",  
                  data:{event_id:event_id,bulan:bulan},  
    ...
    var options = {
          ...
          events: {
            click: function(event, chartContext, config, val) {
              ...
              if (config.dataPointIndex == 0) {
                var event_id = '01';
                var text_judul = 'Sales January 2023'
              }else if(config.dataPointIndex == 1) {
                var event_id = '02';
                var text_judul = 'Sales February 2023'
              }else if(config.dataPointIndex == 2) {
                var event_id = '03';
                var text_judul = 'Sales March 2023'
              }else if(config.dataPointIndex == 3) {
                var event_id = '04';
                var text_judul = 'Sales April 2023'
              }else if(config.dataPointIndex == 4) {
                var event_id = '05';
                var text_judul = 'Sales May 2023'
              }else if(config.dataPointIndex == 5) {
                var event_id = '06';
                var text_judul = 'Sales June 2023'
              }else if(config.dataPointIndex == 6) {
                var event_id = '07';
                var text_judul = 'Sales July 2023'
              }else if(config.dataPointIndex == 7) {
                var event_id = '08';
                var text_judul = 'Sales August 2023'
              }else if(config.dataPointIndex == 8) {
                var event_id = '09';
                var text_judul = 'Sales September 2023'
              }else if(config.dataPointIndex == 9) {
                var event_id = '10';
                var text_judul = 'Sales October 2023'
              }else if(config.dataPointIndex == 10) {
                var event_id = '11';
                var text_judul = 'Sales November 2023'
              }else if(config.dataPointIndex ==11) {
                var event_id = '12';
                var text_judul = 'Sales December 2023'
              }
