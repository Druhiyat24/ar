                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-sm-6 col-md-6 col-lg-3 mb-3">
                                <div class="card dsb-card" onclick="showdata_slsytd()">
                                    ...
                                    <div class="kpi-value">IDR <?= number_format($sls_ytd_inv, 2); ?></div>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-sm-6 col-md-6 col-lg-3 mb-3">
                                <div class="card dsb-card" onclick="showdata_slscm()">
                                    ...
                                    <div class="kpi-value">IDR <?= number_format($sls_cm_inv, 2); ?></div>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-sm-6 col-md-6 col-lg-3 mb-3">
                                <div class="card dsb-card" onclick="showdata_slsytd2()">
                                    ...
                                    <div class="kpi-value">IDR <?= number_format($sls_no_inv + $sls_ytd_inv, 2); ?></div>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-sm-6 col-md-6 col-lg-3 mb-3">
                                <div class="card dsb-card" onclick="showdata_slscm2()">
                                    ...
                                    <div class="kpi-value">IDR <?= number_format($sls_cm_no_inv + $sls_cm_inv, 2); ?></div>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-sm-6 col-md-6 col-lg-3 mb-3">
                                <div class="card dsb-card" onclick="showdata_slsni()">
                                    ...
                                    <div class="kpi-value">IDR <?= number_format($sls_no_inv, 2); ?></div>
                            ...
                            <div class="col-12 col-sm-6 col-md-6 col-lg-3 mb-3">
                                <div class="card dsb-card" onclick="showdata_total_ar()">
                                    ...
                                    <div class="kpi-value">IDR <?= number_format($ar_eqvidr, 2); ?></div>
