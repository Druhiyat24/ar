        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">DataTable Summary Receivable</h3>
                        </div>
                        <div class="d-flex justify-content-between">
                           <div class="ml-auto">
                                        <span class="input-group-text"><i class="fas fa-search"></i></span>
                            </div>
                                <input type="text"  id="cari_noinv" name="cari_noinv" required autocomplete="off" placeholder="Search Customer..." onkeyup="cari_noinvoice()">
                             </div>
                        ...
                        <div class="card-body table-responsive p-0" style="height: 400px;">
                            <table class="table table-bordered table-head-fixed text-nowrap">
                                <thead >
                                    <tr>
                                        <th rowspan="2" style="text-align: center;vertical-align: middle;background: #eee;">Customer</th>
                                        <th rowspan="2" style="text-align: center;vertical-align: middle;background: #eee;">Curr</th>
                                        <th colspan="2" style="text-align: center;vertical-align: middle;background: #eee;">Receivable Balance</th>
                                        <th rowspan="2" style="text-align: center;vertical-align: middle;background: #eee;">Remarks</th>
                                        <th colspan="9" style="text-align: center;vertical-align: middle;background: #eee;">Receivable Aging Based on Due Date</th>
                                        <th rowspan="2" style="text-align: center;vertical-align: middle;background: #eee;"></th>
                                        <th colspan="8" style="text-align: center;vertical-align: middle;background: #eee;">Receivable Due Date Projection</th>
                                    </tr>
                                    <tr>
                                        <th style="text-align: center;vertical-align: middle;">Foreign Curr</th>
                                    ...
                                    <!-- <tr>
                                        <th colspan="22" style="text-align: left;vertical-align: middle;background-color: white;">Account Receivable</th>
                                    </tr> -->
                                </thead>
                                <tbody id="table-sales-local">

                                </tbody>
                                <tbody id="table-sales-export">

                                </tbody>
                                <tbody id="table-summary-sales">

                                </tbody>
                                <tbody id="table-dn-local">

                                </tbody>
                                <tbody id="table-dn-export">

                                </tbody>
                                <tbody id="table-summary-dn">

                                </tbody>
                                <tbody id="table-summary-sales-dn">
