...
<body>
    ...
    <div class="header_title">
        <?= $data_proforma_invoice_cbd['type']; ?> INVOICE <?php
                if ($data_invoice_dpcbd['type'] == 'DP') {
                    echo 'DP';
                }else{
                    echo 'CBD';
                } ?> <br />
        <?= $data_proforma_invoice_cbd['no_pi']; ?>
    </div>
    <br />
    <table style="width:100%;font-size:10px;">
        <tr>
            ...
            <td colspan="3">
                <?= $data_proforma_invoice_cbd['date_pi']; ?>
            </td>
        ...
        <tr>
            ...
            <td colspan="3">
                <?= $data_proforma_invoice_cbd['customer']; ?>
            </td>
            <td class="position_top" colspan="8">
                &nbsp;
            </td>
        ...
        <tr>
            ...
            <td colspan="3">
                <?= $data_proforma_invoice_cbd['phone']; ?>
            </td>
            <td>
            </td>
            <td>
    ...
    <table style="width:100%;font-size:10px;" border="1">
        ...
        <?php
        $qty = 0;
        foreach ($data_proforma_invoice_detail_cbd as $prof_inv_det) : ?>
            <tr>
        ...
        <tr>
            <td colspan="3"></td>
            <td align='right'><?= number_format($data_proforma_invoice_total_cbd['qty'], 2); ?></td>
            <td align='right'><?= number_format($data_proforma_invoice_total_cbd['unit_price'], 2); ?></td>
            <td align='right'><?= number_format($data_proforma_invoice_total_cbd['total_price'], 2); ?></td>
        </tr>
        <tr>
        ...
        <?php
            ...
            <td align="right">'.$data_invoice_dpcbd['amount'].'</td>
        </tr>';
                }else{
                    echo '<tr>
            <td colspan="5">Cash Before Delivery</td>
            <td align="right">'.$data_invoice_dpcbd['amount'].'</td>
        </tr>';
                }
