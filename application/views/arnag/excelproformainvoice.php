...
<body>
    <div class="header_title">
        <?= $data_proforma_invoice['type']; ?> INVOICE <br />
    ...
    <table style="width:100%;font-size:10px;" border="1">
        ...
        foreach ($data_proforma_invoice_detail as $prof_inv_det) : ?>
            <tr>
                <td align='center'><?= $prof_inv_det['so_no']; ?></td>
    ...
    <div style="margin-bottom: 2.54cm; page-break-inside: avoid;">
        ...
        <table style="page-break-inside: avoid; font-size:10px;" border="0">
            ...
            <tr>
                <td>GRAND TOTAL : <?= $data_proforma_invoice_total['curr']; ?> <?= number_format($data_proforma_invoice_total['total_price'], 2); ?></td>
            </tr>
        </table>
