    ...
    <tbody>
        ...
        <?php foreach ($events as $dp) : ?>
            ...
            <tr>
                ...
                <td style="text-align: right;font-size: 0.9rem;color: #2F4F4F"><?= number_format($dp['qty'],2); ?> <?= $satuan; ?></td>
        ...
        <tr>
            ...
            <th style="text-align: right;font-size: 1rem;" scope="col"><?= number_format($jml,2); ?> <?= $satuan; ?></th>
