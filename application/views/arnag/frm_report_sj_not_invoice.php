        ...
        <div class="container-fluid">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="form-group">
                                        <label>Action</label>
                                        <div class="input-group">
                                            <button type="button" id="find_invoice" name="find_invoice" class="btn btn-primary" href="javascript:void(0)" onclick="cari_sj_noncom2()"><i class="fa fa-search"></i>  Search</button>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <label>Export Data</label>
                                        <div class="input-group">
                                            <button type="button" class="btn btn-info" onclick="export_sj_noncom2()"><i class="fa fa-download"></i> Export To Excel</button>
                                        </div>
                                    </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">DataTable SJ Not Yet Invoice</h3>
                        </div>
                        <div class="d-flex justify-content-between">
                           <div class="ml-auto">
                                        <span class="input-group-text"><i class="fas fa-search"></i></span>
                            </div>
                                <input type="text"  id="cari_noinv" name="cari_noinv" required autocomplete="off" placeholder="Search no SJ..." onkeyup="cari_noinvoice()">
                             </div>

                        <!-- /.card-header -->
                        <div class="card-body table-responsive p-0" style="height: 400px;">
                            <table id="table-report_sj_notyet" class="table table-bordered table-head-fixed text-nowrap">
                                <thead >
                                    <tr>
                                        ...
                                        <th style="text-align: center;vertical-align: middle;">SJ Date</th>
                                        <th style="text-align: center;vertical-align: middle;">No Inv</th>
                                        <th style="text-align: center;vertical-align: middle;">Styleno</th>
                                        <th style="text-align: center;vertical-align: middle;">Product Group</th>
                                        <th style="text-align: center;vertical-align: middle;">Product Item</th>
...
<div class="modal fade" id="modal-inv-detail">
    ...
    function cari_noinvoice() {
        ...
        table = document.getElementById("table-report_sj_notyet");
