                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <label>Action</label>
                            <div class="input-group">
                                <button type="button" id="find_profinvoice_post" name="find_profinvoice_post" class="btn btn-primary" href="javascript:void(0)" onclick="cari_dpcbd_invoice_post()"><i class="fa fa-search"></i> Search</button>
                            </div>
                        </div>
                    </div>
                </div>
