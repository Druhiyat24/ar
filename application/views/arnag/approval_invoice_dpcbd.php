        ...
        <div class="container-fluid">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-info">
                        <div class="card-header">
                            <h3 class="card-title">List Proforma Invoice</h3>
                        </div>
                        <!-- /.card-header -->
                    </div>
                </div>
                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <label>Action</label>
                            <div class="input-group">
                                <button type="button" id="find_profinvoice_post" name="find_profinvoice_post" class="btn btn-primary" href="javascript:void(0)" onclick="cari_dpcbd_invoice_second_approv()"><i class="fa fa-search"></i> Search</button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-4">
                            <button type="button" id="approv_inv" name="approv_inv" class="btn btn-warning" onclick="modal_show_approve_invoicedp()"><i class="fa fa-stamp"></i> Approved</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group row">
                        <label for="id_inv_approv1" class="col-sm-5 col-form-label">Approved Invoice DP & CBD? </label>
                    </div>
                </div>
                <div class="modal-footer justify-content-between">
                    <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
                    <button type="button" class="btn btn-primary" onclick="refresh_invdp_second()">Approved</button>
                </div>
            </div>
        </div>
    </form>
