                    ...
                    <div class="card card-success">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <select class="form-control select2bs4" id="profit_center_inm" name="profit_center_inm" required>
                        ...
                        <div class="row col-md-12">
                            <div class="form-group col-md-6">
                                ...
                                <select id="top" name="top" class="form-control select2bs4" required>
                ...
                <div class="col-md-6">
                    ...
                    <div class="card card-success">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group col-md-12">
                                <label>PPh</label>
                                <!-- value tetap "type" (kolom pph existing) - idtax-nya disimpan
                                     terpisah lewat data-idtax -> #id_pph. NA sengaja data-idtax="0"
                                     (BUKAN dikosongkan) biar NULL (data lama) vs 0 (sengaja pilih NA)
                                     bisa dibedain. -->
