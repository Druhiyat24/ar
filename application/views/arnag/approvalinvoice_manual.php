        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-4">
                            <button type="button" id="approv_inv_mnl" name="approv_inv_mnl" class="btn btn-warning" onclick="modal_show_approve_invoice_manual()"><i class="fa fa-stamp"></i> Approved</button>
                        </div>
                    </div>
                </div>
            </div>
