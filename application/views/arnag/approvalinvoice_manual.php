        ...
        <div class="container-fluid">
                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <label>Action</label>
                            <div class="input-group">
                                <button type="button" id="find_invoice_post" name="find_invoice_post" class="btn btn-primary" href="javascript:void(0)" onclick="cari_invoice_manual_second_approv()"><i class="fa fa-search"></i> Search</button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-4">
                            <button type="button" id="approv_inv_mnl" name="approv_inv_mnl" class="btn btn-warning" onclick="modal_show_approve_invoice_manual_second()"><i class="fa fa-stamp"></i> Approved</button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer justify-content-between">
                    ...
                    <button type="button" class="btn btn-primary" onclick="refresh_manual_second()">Approved</button>
                </div>
            </div>
        </div>
    </form>
