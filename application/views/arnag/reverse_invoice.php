        ...
        <div class="container-fluid">
                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <label>Action</label>
                            <div class="input-group">
                                <button type="button" id="find_invoice_post" name="find_invoice_post" class="btn btn-primary" href="javascript:void(0)" onclick="cari_invoice_appv()"><i class="fa fa-search"></i> Search</button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-4">
                            <button type="button" id="approv_inv" name="approv_inv" class="btn btn-danger" onclick="modal_show_reverse_invoice()"><i class="fa fa-undo"></i> Reverse</button>
                        </div>
                    </div>
                </div>
            </div>
...
<div class="modal fade" id="modal-reverse-invoice">
    <form>
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer justify-content-between">
                    ...
                    <button type="button" class="btn btn-primary" onclick="refresh_rvs()">Reverse</button>
                </div>
            </div>
        </div>
    </form>
