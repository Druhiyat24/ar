...
<body>
	...
	<table style="width:100%;font-size:10px;" border="1">
		...
		?>
			<tr>
				...
				<td style="width: 15%; text-align: center;"><?= $alok_det['no_ref']; ?></td>
				<td style="width: 10%; text-align: center;"><?= $alok_det['ref_date']; ?></td>
				<td style="width: 10%; text-align: center;"><?= $alok_det['due_date']; ?></td>
				<td style="width: 10%; text-align: right;"><?= $alok_det['total']; ?></td>
				<td style="width: 10%; text-align: right;"><?= $alok_det['ost']; ?></td>
				<td style="width: 15%; text-align: right;"><?= $alok_det['amount']; ?></td>
			</tr>
		<?php endforeach; ?>
		...
		<tr>
			...
			<td align='right'><?= $alok_det['curr']; ?> <?= $data_alokasi['amount']; ?></td>
		</tr>

		<tr>
			<td colspan='7'>Rate</td>
			<td align='right'><?= $data_alokasi['rate']; ?></td>
		</tr>

		<tr>
			<td colspan='7'>Equivalent IDR</td>
			<td align='right'>IDR <?= $data_alokasi['eqp_idr']; ?></td>
		</tr>
	...
	<div style="margin-bottom: 2.54cm; page-break-inside: avoid;">
		...
		<table style="page-break-inside: avoid; font-size:10px;" border="0">
			...
			<tr>
				<td>GRAND TOTAL : <?= $alok_det['curr']; ?> <?= $data_alokasi['amount']; ?></td>
			</tr>
		</table>
