                                ...
                                <div class="row align-items-end">
                                    ...
                                    <div class="col-md-2">
                                        <div class="d-flex" style="gap:6px;">
                                            ...
                                            <button type="button" class="btn btn-info" onclick="export_list_invoice()"><i class="fa fa-download"></i> Export</button>
                                        </div>
                                    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer justify-content-between">
                    ...
                    if ($data == 'willy' || $data == 'frisca' || $data == 'hady' || $data == 'hadi' || $data == 'jefri' || $data == 'ramon' || $data == 'lukman' || $data == 'putrie') 
                    {
