        ...
        <div class="container-fluid">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-info">
                        <div class="card-header">
                            <h3 class="card-title">List Invoice Manual</h3>
                        </div>
                        <!-- /.card-header -->
                    </div>
                </div>
                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <label>Action</label>
                            <div class="input-group">
                                <button type="button" id="find_invoice_post" name="find_invoice_post" class="btn btn-primary" href="javascript:void(0)" onclick="cari_invoice_manual_appv()"><i class="fa fa-search"></i> Search</button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-4">
                            <button type="button" id="approv_inv_mnl" name="approv_inv_mnl" class="btn btn-warning" onclick="modal_show_reverse_invoice_manual()"><i class="fa fa-stamp"></i> Reverse</button>
                        </div>
                    </div>
                </div>
            </div>
...
<div class="modal fade" id="modal-reverse-invoice-manual">
    <form>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group row">
                        <label for="id_inv_approv1" class="col-sm-5 col-form-label">Reverse Invoice? </label>
                    </div>
                </div>
                <div class="modal-footer justify-content-between">
                    <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
                    <button type="button" class="btn btn-primary" onclick="refresh_manual_rvs()">Reverse</button>
                </div>
            </div>
        </div>
    </form>
