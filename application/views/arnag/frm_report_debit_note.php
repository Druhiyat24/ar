                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-info">
                        <div class="card-header">
                            <h3 class="card-title">Mutasi Debit Note</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form>
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control float-right" id="cobacoba3" name="cobacoba3">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label>Action</label>
                                        <div class="input-group">
                                            <button type="button" id="find_invoice" name="find_invoice" class="btn btn-primary" href="javascript:void(0)" onclick="cari_mutasi_debit_note()"><i class="fa fa-search"></i> Search</button>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <label>Export Data</label>
                                        <div class="input-group">
                                            <button type="button" class="btn btn-info" onclick="export_mutasi_debit_note()"><i class="fa fa-download"></i> Export To Excel</button>
                                        </div>
                                    </div>
                    ...
                    <div class="card">
                        ...
                        <div class="d-flex justify-content-between">
                           <div class="ml-auto">
                                ...
                                <input type="text"  id="cari_noinv" name="cari_noinv" required autocomplete="off" placeholder="Search no debit note..." onkeyup="cari_noinvoice()">
                             </div>

                        <!-- /.card-header -->
                        <div class="card-body table-responsive p-0" style="height: 400px;">
                            <table id="table-mutasi_debitnote" class="table table-bordered table-head-fixed text-nowrap">
                                <thead >
                                    <tr border= "1">
                                        <th rowspan="2" style="text-align: center;vertical-align: middle;">Customer</th>
                                        <th rowspan="2" style="text-align: center;vertical-align: middle;">No Debit Note</th>
                                        <th rowspan="2" style="text-align: center;vertical-align: middle;">Debit Note Date</th>
