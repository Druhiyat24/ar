                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-info">
                        <div class="card-header">
                            <h3 class="card-title">Cek Kwitansi</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form>
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="form-group">
                                        <label>Action</label>
                                        <div class="input-group">
                                            <button type="button" id="find_invoice" name="find_invoice" class="btn btn-primary" href="javascript:void(0)" onclick="cari_kwitansi()"><i class="fa fa-search"></i> Search</button>
                                        </div>
                                    </div>
                                   <!--  <div class="col-md-3">
                    ...
                    <div class="card">
                        ...
                        <div class="d-flex justify-content-between">
                           <div class="ml-auto">
                                ...
                                <input type="text"  id="cari_nokwt" name="cari_nokwt" required autocomplete="off" placeholder="Search No Kwitansi.." onkeyup="cari_kwt()">
                             </div>
                        ...
                        <div class="card-body table-responsive p-0" style="height: 400px;">
                            <table id="table-kwitansi" class="table table-head-fixed text-nowrap">
                                <thead>
                                    <tr>
                                        <th style="text-align: center;">Kwitansi Number</th>
                                        <th style="text-align: center;">Kwitansi Date</th>
