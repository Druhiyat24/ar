...
<body>
    ...
    <table style="width:100%;font-size:10px;" border="1" >
        ...
        foreach ($data_debit_note_det2 as $prof_inv_det2) : ?>
            <tr>
                <td style="text-align: left; vertical-align: top;"><?= $prof_inv_det2['deskripsi']; ?></td>
                <td style="text-align: left; vertical-align: top;"><?= $prof_inv_det2['supplier']; ?></td>
                <td style="text-align: left; vertical-align: top;"><?= $prof_inv_det2['supplier_invoice']; ?></td>
                <?php
                if ($prof_inv_det2['header1'] != '') {
            ...
            ?>
                ...
                <?php
                if ($prof_inv_det['header1'] != '' &&  $prof_inv_det2['id_det'] ==  $prof_inv_det['id_det'] ) {
                    
                echo $prof_inv_det['header1']. "<br/>\n";
                }else{
                }
       ...
       <?php
        ...
        <?php
            ...
            ?>
                ...
                foreach ($data_debit_note_det as $prof_inv_det): ?>
                <?php
                if ($prof_inv_det['header2'] != '' &&  $prof_inv_det2['id_det'] ==  $prof_inv_det['id_det']) {
                    
                echo $prof_inv_det['header2']. "<br/>\n";
                }else{
                }
        ...
        <?php
            ...
            ?>
                ...
                foreach ($data_debit_note_det as $prof_inv_det): ?>
                <?php
                if ($prof_inv_det['header3'] != '' &&  $prof_inv_det2['id_det'] ==  $prof_inv_det['id_det']) {
                    
                echo $prof_inv_det['header3']. "<br/>\n";
                }else{
                }
            ?>
            <?php endforeach; ?>
        <?php
            ...
            ?>
                <td style="text-align: right; vertical-align: top;"><?= $prof_inv_det2['amount']; ?></td>
                <td style="text-align: right; vertical-align: top;"><?= $prof_inv_det2['rate']; ?></td>
                <td style="text-align: right; vertical-align: top;width: 100px"><?= $prof_inv_det2['amount2']; ?></td>
        <?php endforeach; ?>
    </tr>
...
<!--                 <td style="font-size:12px;text-align:center;text-decoration:underline"> </td>          
                ...
                <td style="font-size:12px;border-top: none;border-bottom: none;border-right: none;border-left: none;"></td>
                <td style="font-size:12px;text-align:center;border-top: none;border-bottom: none;border-right: none;border-left: none;">Finance Manager</td>
            </tr>
            <tr>
                <td style="font-size:12px;border-top: none;border-bottom: none;border-right: none;border-left: none;"></td>
                <td style="font-size:12px;border-top: none;border-bottom: none;border-right: none;border-left: none;"></td>
