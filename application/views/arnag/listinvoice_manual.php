                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="form-group">
                                        <label>Action</label>
                                        <div class="input-group">
                                            <button type="button" id="find_invoice" name="find_invoice" class="btn btn-primary" href="javascript:void(0)" onclick="cari_invoice_nb()"><i class="fa fa-search"></i> Search</button>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <label>Export Data</label>
                                        <div class="input-group">
                                            <button type="button" class="btn btn-info" onclick="export_list_invoice_nb()"><i class="fa fa-download"></i> Export To Excel</button>
                                        </div>
                                    </div>
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body table-responsive p-0" style="height: 300px;">
                            <table id="table-invoice-nb" class="table table-head-fixed text-nowrap">
                                <thead>
                                    <tr>
                                        <th>Inv Number</th>
                                        <th>Customer</th>
...
<div class="modal fade" id="modal-inv-detail-nb">
                ...
                <div class="form-group">
                    <div class="col-md-4">
                        ...
                        <div class="input-group mb-3">
                            <input type="text" class="form-control" id="inv_number_list-nb" name="inv_number_list" readonly>
                        </div>
                    </div>
                </div>
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-body table-responsive p-0" style="height: 400px;">
                            <table id="table-inv-detail-nb" class="table table-head-fixed text-nowrap">
                                <thead>
                                    <tr>
                                        <th>SO Number</th>
                                        <th>Bppb Number</th>
