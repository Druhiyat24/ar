                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="form-group">
                                        <label>Action</label>
                                        <div class="input-group">
                                            <button type="button" id="find_invoice_pi" name="find_invoice_pi" class="btn btn-primary" href="javascript:void(0)" onclick="cari_proforma_invoice_cbd()"><i class="fa fa-search"></i> Search</button>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <label>Export Data</label>
                                        <div class="input-group">
                                            <button type="button" class="btn btn-info" onclick="export_list_pi_cbd()"><i class="fa fa-download"></i> Export</button>
                                        </div>
                                    </div>
                                    <!-- <div class="col-md-1">
                                        <label>Create</label>
...
<div class="modal fade" id="modal-update-faktur-pjk_cbd">
    <form action="<?= base_url('arnag/update_faktur_pajak_cbd'); ?>" method="POST">
