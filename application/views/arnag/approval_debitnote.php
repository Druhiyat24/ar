                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <label>Action</label>
                            <div class="input-group">
                                <button type="button" id="find_profinvoice_post" name="find_profinvoice_post" class="btn btn-primary" href="javascript:void(0)" onclick="cari_debitnote_second_approv()"><i class="fa fa-search"></i> Search</button>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer justify-content-between">
                    ...
                    <button type="button" class="btn btn-primary" onclick="refresh_dn_second()">Approved</button>
                </div>
            </div>
        </div>
    </form>
