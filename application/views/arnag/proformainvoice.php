                     ...
                     <div class="row">
                         <div class="col-md-6">
                             ...
                             <div class="form-group">
                                 <label>Shipp</label>
                                 <div class="input-group mb-3">
                                     <input type="text" class="form-control" id="prof_shipp" name="prof_shipp" required autocomplete="off">
                                     <span class="input-group-append">
                                         <button id="prof_L" name="prof_L" type="button" class="btn btn-success btn-flat" onclick="get_kode_proforma_invoice('L')"><i class="fa fa-car"></i> Local</button>
                                         <button id="prof_E" name="prof_E" type="button" class="btn btn-info btn-flat" onclick="get_kode_proforma_invoice('E')"><i class="fa fa-plane"></i> Export</button>
                                     </span>
                                 </div>
                             </div>
                             <div class="form-group">
                                         ...
                                         <div class="form-group row">
                                             ...
                                             <div class="col-sm-8">
                                                <div class="input-group">
                                                 <input type="text" class="form-control" id="prof_diskon" name="prof_diskon" oninput="input_diskon_proforma()" style="text-align:right;width: 50px;" placeholder="0.00">
                                     ...
                                     <div class="card-body">
                                         ...
                                         <div class="form-group row">
                                             <div class="custom-control custom-checkbox col-sm-4">
                                                 <input class="custom-control-input" type="checkbox" id="prof_check_dp" name="prof_check_dp" onclick="check_dp(this)">
                                                 <label for="prof_check_dp" class="custom-control-label">DP Max 75%</label>
                                             </div>
                                             <div class="col-sm-8">
                                                 <div class="input-group" >
                                                 <input type="text" class="form-control" id="prof_dp" name="prof_dp" style="text-align:right;" placeholder="0.00" readonly onkeypress="javascript:return isNumber(event)" oninput="input_dp_proforma_invoice()">
                 ...
                 <div class="card-footer">
                     <div class="row col-sm-12">
                         <div class="input-group mb-3">
                             ...
                             <button type="button" class="btn btn-primary" data-toggle="modal" onclick="add_data_proforma_invoice()"><i class="fa fa-save"></i> Save Change</button>
                         </div>
                     </div>
                 </div>
             </div>
                 ...
                 <div class="card">
                     <div class="card-header">
                         ...
                         <div class="row">
                             ...
                             <div class="col-md-4">
                                 <button type="button" id="prof_find_so" name="prof_find_so" class="btn btn-info" href="javascript:void(0)" onclick="cari_so_proforma()"><i class="fa fa-search"></i> Search</button>
                             </div>
                         </div>
                         <!-- ID Customer -->
                         <div class="col-md-2">
     ...
     <div class="modal-dialog">
         <div class="modal-content">
             ...
             <div class="modal-footer justify-content-between">
                 ...
                 <button type="button" class="btn btn-primary toastrDefaultSuccess" onclick="save_proforma_invoice()">Save Change</button>
             </div>
         </div>
     </div>
 </div>
