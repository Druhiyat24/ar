<table class="table table-striped text-nowrap" width="100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="text-align: right;" scope="col">Total Value</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php $i = 1; 
                                        ...
                                        <!-- <tr>
                                            ...
                                            <th style="text-align: left;font-size: 1rem;" scope="col">IDR <?= number_format($jml,2); ?></th>
                                            <th style="text-align: left;font-size: 1rem;" scope="col">IDR <?= number_format($jml2,2); ?></th>
                                        </tr> -->
                                    </tbody>
                                </table>