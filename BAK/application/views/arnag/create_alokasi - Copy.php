                ...
                <div class="col-md-6">
                    ...
                    <div class="card card-dark">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <div class="input-group mb-3">
                                    <div class="input-group date" id="reservationdate" data-target-input="nearest">
                                                <input type="text" class="form-control datetimepicker-input" data-target="#reservationdate" name="alo_date" id="alo_date" value="<?php echo date("Y-m-d"); ?>" required autocomplete="off">
                            ...
                            <div class="form-group col-md-12">
                                <label>Account</label>
                                <input type="text" class="form-control" id="acc" name="acc" autocomplete='off' required>
                            </div>
                            <!--  End Start Input -->
                        </div>
                        <!-- /.card-body -->
