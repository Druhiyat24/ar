...
// 					$.each(response, function (i, item) {
// 						trHTML += '<tr>';		
// 						trHTML += '<td><select class="form-control select2alok" name="coa" style="width: 300px;" data-width="300px" data-live-search="true" data-size="5"> <option value="-" > - </option> <?php foreach ($coa as $coa) : ?> <option value="<?= $coa["id_coa"]; ?>"><?= $coa["id_coa"]; ?> <?= $coa["coa_name"]; ?> </option><?php endforeach; ?> </select></td>';		
...
// 						trHTML += '<td><select style="width: 250px" class="form-control " name="supp" id="supp" ><option value="'+ item.supplier +'">'+ item.supplier +'</option></select></td>';
...
// 						trHTML += '<td hidden><input type="checkbox" name="id_memo_det" id="id_memo_det" class="flat" value = ' + item.no_invoice + ' checked></td>';
